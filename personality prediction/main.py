...
def perdict_person():
    ...
    l5=Label(top, text="Enjoy New Experience or new ways of doing things(Openness)", foreground='white', bg='black').place(x=70, y=250)
...
if __name__ == "__main__":
    ...
    lab=Label(root, text="Personality Prediction Using CV Analysis", bg='white', font=titleFont, pady=30).pack()
